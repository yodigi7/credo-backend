...
create table if not exists payment (id numeric(19) not null, created_by varchar(255), created_dt timestamp, updated_by varchar(255), updated_dt timestamp, payment_amount float8, payment_date timestamp, payment_notes varchar(2000), person_id numeric(19), primary key (id));
