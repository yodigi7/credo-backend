...
alter table donation add constraint if not exists fk_donation_person foreign key (person_id) references person;
alter table email add constraint if not exists fk_email_person foreign key (person_id) references person;
alter table event add constraint if not exists fk_event_person foreign key (person_id) references person;
alter table person add constraint if not exists fk_person_address foreign key (address_id) references address;
alter table person add constraint if not exists fk_person_parish foreign key (parish_id) references parish;
alter table phone add constraint if not exists fk_phone_person foreign key (person_id) references person;
